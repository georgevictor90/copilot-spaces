...
Welcome — this folder centralizes OctoAcme's project management processes and templates. The docs here give new and returning team members a single place to learn how projects are initiated, planned, executed, released, and improved. Use this README as your starting point and follow links to the detailed guidance for each process area.
...
- [x] README improves discoverability and onboarding
- [ ] Proposed content reviewed by stakeholders (if needed)
